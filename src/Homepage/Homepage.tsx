                        ...
                        <div className="homepage-modal">
                            ...
                            <div className="homepage-modal-content">
                                ...
                                <ul>
                                    ...
                                    <br />
                                    <li><strong>Expanded Therapy Services:</strong> We're adding <strong>occupational</strong> and <strong>speech therapy</strong> providers to our platform, making it easier for you to find comprehensive care options for your child all in one place.</li>
                                    <br />
