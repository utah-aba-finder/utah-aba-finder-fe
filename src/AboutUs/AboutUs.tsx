          ...
          <div className="front-end-container card">
            ...
            <div className="profile-card">
              ...
              <div className="profile-info">
                ...
                <p>
                  {" "}
                  Jordan is a front-end developer with a background as a
                  Military Working Dog Handler in the U.S. Army, holding degrees
                  in Criminal Justice and IT with a concentration in programming
                  and software development, and a father of two ASD children.
                </p>
                <div className="icon-container">
                  <a
                    href="https://www.linkedin.com/in/jordan-williamson-a079b3271/"
                    target="_blank"
            ...
            <div className="profile-card">
              ...
              <div className="profile-info">
                <h3>Kevin Nelson</h3>
                <p>
                  Kevin Nelson is a software engineer with a background in
                  business and legal operations, who combines his Juris
                  Doctorate and Business Administration degrees to bridge the
                  gap between business/law and tech.
                </p>
                <div className="icon-container">
                  <a
                    href="https://www.linkedin.com/in/kevinnelson418/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                  ...
                  <a
                    href="https://github.com/kevinm23nelson"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
            ...
            <div className="profile-card">
              ...
              <div className="profile-info">
                <h3>Seong Kang</h3>
                <p>
                  Seong is passionate about accessibility, responsive design,
                  and creating better UI/UX, blending a background in the U.S.
                  Army, behavioral health, and entertainment technology with
                  skills in React, JavaScript, HTML, and CSS.
                </p>
                <div className="icon-container">
                  <a
                    href="https://www.linkedin.com/in/seong-kang/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                  ...
                  <a
                    href="https://github.com/sanghoro"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
          ...
          <div className="back-end-container card">
            ...
            <div className="profile-card">
              ...
              <div className="profile-info">
                ...
                <p>
                  Austin is a software engineer with a background in sales,
                  using technologies like Ruby on Rails, RSpec, PostgreSQL, SQL,
                  and Bootstrap to build effective solutions, leveraging 14
                  years of experience in optimizing CRM workflows and driving
                  growth.
                </p>
                <div className="icon-container">
                  <a
                    href="https://www.linkedin.com/in/austin-carr-jones/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                  ...
                  <a
                    href="https://github.com/austincarrjones"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
            ...
            <div className="profile-card">
              ...
              <div className="profile-info">
                <h3>Chee Lee</h3>
                <p>
                  Chee is a software engineer with a background in healthcare,
                  bringing analytical skills and a unique problem-solving
                  perspective from five years in interventional radiology, and
                  is eager to apply these abilities to developing innovative
                  software solutions.
                </p>
                <div className="icon-container">
                  <a
                    href="https://www.linkedin.com/in/chee-lee-rtr/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                  ...
                  <a
                    href="https://github.com/cheeleertr"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
