          ...
          <div className="text-center mt-3">
            <p className="text-sm text-gray-600">
              {isClaimMode 
                ...
                : "Register as a new provider in our network"
              }
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-amber-700">
                  <strong>Important:</strong> If you're already listed as a provider in our system, please use "Claim Existing Account" instead of registering again. 
                  This helps us avoid duplicates and gets you access faster. You can search for your provider name on our{' '}
                  <Link to="/providers" className="underline hover:text-amber-900 font-medium">
                    providers page
                  </Link>{' '}
                  to check if you're already listed.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="form-group">
                      <label className="block text-sm font-medium text-gray-700 mb-2">Provider Name (Company Name)*</label>
                      <input
                        type="text"
