...
export const API_CONFIG = {
  ...
  // API URLs - Use production API when in production, Heroku API for development
  BASE_API_URL: process.env.REACT_APP_BASE_API_URL || (process.env.NODE_ENV === 'production' 
    ? 'https://autismserviceslocator.com/api' 
    : 'https://utah-aba-finder-api-c9d143f02ce8.herokuapp.com'),
  ADMIN_API_URL: process.env.REACT_APP_ADMIN_API_URL || (process.env.NODE_ENV === 'production' 
    ? 'https://autismserviceslocator.com/api' 
    : 'https://utah-aba-finder-api-c9d143f02ce8.herokuapp.com'),
