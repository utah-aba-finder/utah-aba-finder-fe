            ...
            <div className='info-page'>
                ...
                <div className='info-content'>
                    ...
                    <section className='info-content-section2'>
                        ...
                        <p>There is no cure for autism spectrum disorder (ASD), but treatments can help improve symptoms and support development and learning. The goal of treatment is to help people with ASD function better in their daily lives and improve their quality of life. Treatments can be provided in a variety of settings, including at home, in the community, in schools, or through health services.</p>
                    </section>
                    <section className='info-content-section3'>
                        <h2 className='info-content-title'>Treatments for ASD can include:</h2>
                        <ul>
